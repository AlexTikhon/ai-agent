...
:root {
  --shadow-none:  none;
  --shadow-xs:    0 1px 2px rgba(26,23,20,.06), 0 1px 1px rgba(26,23,20,.04);
  --shadow-sm:    0 2px 4px rgba(26,23,20,.08), 0 1px 2px rgba(26,23,20,.06);
  --shadow-md:    0 4px 8px rgba(26,23,20,.10), 0 2px 4px rgba(26,23,20,.06);
  --shadow-lg:    0 8px 16px rgba(26,23,20,.12), 0 4px 8px rgba(26,23,20,.06);
  --shadow-xl:    0 16px 32px rgba(26,23,20,.14), 0 8px 16px rgba(26,23,20,.08);
  --shadow-2xl:   0 32px 64px rgba(26,23,20,.18), 0 16px 32px rgba(26,23,20,.10);
  --shadow-inner: inset 0 2px 4px rgba(26,23,20,.08);
  --shadow-focus: 0 0 0 2px var(--color-bg-surface),
                  0 0 0 5px rgba(101,53,224,.35);
  --shadow-focus-danger: 0 0 0 2px var(--color-bg-surface),
                         0 0 0 5px rgba(220,38,38,.30);
}
```
...
module.exports = {
  theme: {
    extend: {
      colors: {
        violet: {
          50: '#F8F5FF', 100: '#EEE8FF', 200: '#D9CEFF',
          300: '#BBA8FF', 400: '#9879F8', 500: '#7B54F0',
          600: '#6535E0', 700: '#5122C4', 800: '#3E19A0',
          900: '#2D1180', 950: '#180960',
        },
        amber: { /* as above */ },
        stone: { /* as above */ },
        // Semantic shortcuts
      ...
      transitionDuration: {
        instant: '80ms', fast: '150ms', normal: '200ms',
        medium: '300ms', slow: '500ms',
      },
    },
  },
}
...
<button data-variant="primary" data-size="md" data-loading="true">

<!-- State via Tailwind data- variants -->
<button class="data-[loading=true]:cursor-wait data-[loading=true]:opacity-80">
```
